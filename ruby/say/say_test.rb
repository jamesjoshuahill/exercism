...
class SayTest < MiniTest::Unit::TestCase
  ...
  def assert_power_of_ten(power:, number:)
    assert_equal power, Say.new(0).send(:power_of_ten, number)
  end

  def test_power_of_ten
    assert_power_of_ten(power: 0, number: 1)
    assert_power_of_ten(power: 0, number: 9)
    assert_power_of_ten(power: 1, number: 10)
    assert_power_of_ten(power: 1, number: 11)
    assert_power_of_ten(power: 2, number: 100)
    assert_power_of_ten(power: 2, number: 101)
    assert_power_of_ten(power: 2, number: 999)
    assert_power_of_ten(power: 3, number: 1_000)
    assert_power_of_ten(power: 3, number: 1_234)
    assert_power_of_ten(power: 4, number: 10_000)
    assert_power_of_ten(power: 5, number: 100_000)
    assert_power_of_ten(power: 5, number: 999_999)
    assert_power_of_ten(power: 6, number: 1_000_000)
    assert_power_of_ten(power: 6, number: 1_000_001)
  end
